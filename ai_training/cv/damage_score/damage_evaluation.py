...
def process_one_car(
    ...
    if n_imgs <= 0:
        msg = f"no usable images, got {n_imgs}"
        result = {
            "vin": vin,
            "auction": auction,
            "damage_primary_severity": None,
...
def parse_args():
    ...
    parser.add_argument("--yolov8m30_imgsz", type=int, default=768)
    parser.add_argument("--yolov8m30_conf", type=float, default=0.5)
    parser.add_argument("--yolov8m30_iou_tile", type=float, default=0.45)
    parser.add_argument("--yolov8m30_iou_merge", type=float, default=0.3)
    parser.add_argument("--yolov8m30_overlap", type=float, default=0.15)

    parser.add_argument("--yolov8m120_imgsz", type=int, default=896)
    ...
    parser.add_argument("--yolov8m120_iou_merge", type=float, default=0.3)
    parser.add_argument("--yolov8m120_overlap", type=float, default=0.15)
